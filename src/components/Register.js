  ...
  render() {
    ...
    <View style={styles.container}>
        ...
        <View style={styles.content}>
            <TextInput value={this.props.nome} onChangeText={texto => this.props.modificaNome(texto)} style={styles.inputs} placeholder="Nome" placeholderTextColor='#fff' underlineColorAndroid="transparent" />
...
const mapStateToProps = state => (
  ...
  //decorator
  export default connect(mapStateToProps, { modificaEmail, modificaSenha, modificaNome })(Register)
